...
export class InitialSchema1764728503748 implements MigrationInterface {
    name = 'InitialSchema1764728503748'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "producto" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" character varying NOT NULL, "precio" integer NOT NULL, "stock" integer NOT NULL, "categoria_id" uuid, CONSTRAINT "PK_5be023b11909fe103e24c740c7d" PRIMARY KEY ("id"))`);
